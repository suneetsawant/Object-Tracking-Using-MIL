function [patch,x_patch,y_patch] = crop(I,center,r,beta,Height,T,step_size)
...
t = 1;
for y=center(2)-beta:step_size:center(2)+beta
    for x=center(1)-beta:step_size:center(1)+beta
